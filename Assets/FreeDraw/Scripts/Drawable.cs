...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        // PEN COLOUR
        public static Color Pen_Colour = new Color(0, 0, 0, 0);     // Change these to change the default drawing settings
        ...
        void Update()
        {
            ...
            if (mouse_held_down && !no_drawing_on_current_drag)
            {
                ...
                Vector2 mouse_world_position = pointer.position;//Camera.main.ScreenToWorldPoint(Input.mousePosition);

                // Check if the current mouse position overlaps our image
                Collider2D hit = Physics2D.OverlapPoint(mouse_world_position, Drawing_Layers);
